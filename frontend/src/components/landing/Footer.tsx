...
const footerLinks = {
  product: [
    ...
    { label: "Location Scout", href: "/app" },
    { label: "Market Validator", href: "/app" },
    { label: "Competitor Analyzer", href: "/app" },
  ],
  company: [
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-white/60 max-w-xs">
              AI-powered analytics for small business owners. Make smarter decisions with data-driven insights.
            </p>
            {/* Social Icons */}
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} PHOW. All rights reserved.
          </p>
          <p className="text-sm text-white/40">
            Made with AI for small business owners
          </p>
        </div>
      </div>
    </footer>
