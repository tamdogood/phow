        ...
        <div className="relative">
          ...
          >
            ...
            <div className="h-[400px] md:h-[500px] relative">
              ...
              {/* Floating Widgets - Increased margins for better spacing */}
              {/* Location Score Widget - Top Left */}
              <div
                className={`absolute top-8 left-8 bg-white border border-gray-200 rounded-xl p-5 w-48 shadow-lg animate-slide-in-left ${isVisible ? "" : "opacity-0"}`}
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-900 text-xs font-medium">Location Score</span>
                </div>
              ...
              <div
                className={`absolute top-8 right-8 bg-white border border-gray-200 rounded-xl p-5 w-48 shadow-lg animate-slide-in-right ${isVisible ? "" : "opacity-0"}`}
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-900 text-xs font-medium">Competitors</span>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-900 text-xs">Within 0.5mi</span>
                    <span className="text-gray-900 font-semibold text-sm">12</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-900 text-xs">Avg Rating</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-900 text-xs">Price Level</span>
              ...
              <div
                className={`absolute bottom-8 left-8 bg-white border border-gray-200 rounded-xl p-5 w-48 shadow-lg animate-slide-in-left ${isVisible ? "" : "opacity-0"}`}
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-900 text-xs font-medium">Transit Access</span>
                </div>
              ...
              <div
                className={`absolute bottom-8 right-8 bg-white border border-gray-200 rounded-xl p-5 w-48 shadow-lg animate-slide-in-right ${isVisible ? "" : "opacity-0"}`}
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-900 text-xs font-medium">Demographics</span>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-900 text-xs">Foot Traffic</span>
                    <span className="text-gray-900 font-semibold text-sm">High</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-900 text-xs">Median Income</span>
                    <span className="text-gray-900 font-semibold text-sm">$95K</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-900 text-xs">Age Group</span>
              ...
              {/* AI Insight Banner */}
              <div
                className={`absolute bottom-20 left-1/2 -translate-x-1/2 bg-white border border-gray-200 rounded-full px-5 py-2.5 shadow-lg animate-fade-in-up ${isVisible ? "" : "opacity-0"}`}
